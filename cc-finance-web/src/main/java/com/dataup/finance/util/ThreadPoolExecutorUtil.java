...
public class ThreadPoolExecutorUtil {
	 ...
	 public static ThreadPoolExecutorUtil threadPoolExecutorUtil;
	 ...
	 public static ThreadPoolExecutorUtil  getInstance() {
		 if(threadPoolExecutorUtil != null) {
		     ...
		     */  
			 threadPoolExecutorUtil.threadpool=new ThreadPoolExecutor(2, 10, 20, TimeUnit.SECONDS, new ArrayBlockingQueue(10),new ThreadPoolExecutor.DiscardOldestPolicy());   
		 }
